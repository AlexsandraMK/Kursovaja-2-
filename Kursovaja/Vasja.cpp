...
//#include <fstream>
//using namespace std;
//int n_nodes = 0, n_elem = 0, n_cond = 0, n_layer = 0, funcNum = 0;
...
//		// u(x, y, t) = x^2+y^2
//	case (0):
//		return -4 * Lambda(funcNum, k);
//		// u(x, y, t) = (x^2+y^2)t
//	case (1):
//		return sigma * (k.x * k.x + k.y * k.y) - 4 * Lambda(funcNum, k) * time;
//		// u(x, y, t) = (x^2+y^2)t^2
//	case (2):
//		return 2 * chi * (k.x * k.x + k.y * k.y) + 2 * time * sigma * (k.x * k.x + k.y * k.y) - 4 * Lambda(funcNum, k) * time * time;
//		// u(x, t) = (x^2+y^2)*t^3
//	case(3):
//		return 6 * chi * time * (k.x * k.x + k.y * k.y) + 3 * time * time * sigma * (k.x * k.x + k.y * k.y) - 4 * Lambda(funcNum, k) * time * time * time;
//		// u(x, t) = x^2*t^4
//	case(4):
//		return 12 * chi * time * time * (k.x * k.x + k.y * k.y) + 4 * time * time * time * sigma * (k.x * k.x + k.y * k.y) - 4 * Lambda(funcNum, k) * time * time * time * time;
//	default:
//		break;
//	}
//}
...
//		// u(x, t) = (x^2+y^2)t
//	case 1:
//		return (k.x * k.x + k.y * k.y) * time;
//		// u(x, t) = (x^2+y^2)t^2
//	case 2:
//		return (k.x * k.x + k.y * k.y) * time * time;;
//		// u(x, t) = (x^2+y^2)t^3
//	case 3:
//		return (k.x * k.x + k.y * k.y) * time * time * time;
//		// u(x, t) = (x^2+y^2)t^4
//	case 4:
//		return (k.x * k.x + k.y * k.y) * time * time * time * time;
//	default:
//		break;
//	}
//}
...
//	buff = detD / 360;
//	f1 = Func(funcNum, el.knts[0], el, time);
//	f2 = Func(funcNum, el.knts[1], el, time);
//	f3 = Func(funcNum, el.knts[2], el, time);
//	f4 = Func(funcNum, el.knts[3], el, time);
//	f5 = Func(funcNum, el.knts[4], el, time);
//	f6 = Func(funcNum, el.knts[5], el, time);
...
//		A.di[index] = 1;
//		b[index] = FirstCondition(funcNum, nodes[index], time);
//		ibeg = A.ig[index];
//		iend = A.ig[index + 1];
